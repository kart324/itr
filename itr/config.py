...
class Config:
    ...
    base_log_dir: str = '/content/drive/My Drive/OffNote/itr-master/logs'
    base_output_dir: str = '/content/drive/My Drive/OffNote/itr-master/output'
...
hc1 = Config(data='/content/drive/My Drive/OffNote/itr-master/data/hin-eng/',
                    exp_name='default',
                    lang='hi',
                )
